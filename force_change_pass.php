...
//includes a databse connection
include('includes/config.php');

$msg="";

//fetch all leave type
$query = "SELECT qno, Question FROM dbo.Tbl_FunQuz";
$funqz = sqlsrv_query($dbhandle, $query);
                ...
                <div class="col-lg-6">
                    <div class="card bg-secondary shadow border-0">
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                          ...
                          <form  method="post" action ="production/force_changes_pass.php" class="form-horizontal form-label-left" >
                                ...
                                <div class="form-group">
                                  <div class="input-group input-group-alternative">
                                    ...
                                    <select class="select2_single form-control" tabindex="-1" name = "funqz">
                                        <option> Select Funqz </option>
                                      <?php
                                        while($row = sqlsrv_fetch_array($funqz))
                                            {
                                ...
                                <div class="form-group mb-3 ">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" placeholder="Fun Answer" type="text" name="funans"
